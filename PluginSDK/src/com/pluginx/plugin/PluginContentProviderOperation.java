...
public class PluginContentProviderOperation implements Parcelable {
     ...
     * {@link Builder}.
     */
    private PluginContentProviderOperation(Builder builder) {
        mType = builder.mType;
        mUri = builder.mUri;
    ...
    private PluginContentProviderOperation(Parcel source) {
        ...
        mSelectionArgs = source.readInt() != 0 ? readStringArray(source) : null;
    ...
    private final String[] readStringArray(Parcel source) {
        String[] array = null;
     ...
     */
    public ContentProviderResult apply(PluginContentProvider provider, ContentProviderResult[] backRefs,
    ...
    public static final Creator<PluginContentProviderOperation> CREATOR =
            new Creator<PluginContentProviderOperation>() {
        public PluginContentProviderOperation createFromParcel(Parcel source) {
            return new PluginContentProviderOperation(source);
        }

        public PluginContentProviderOperation[] newArray(int size) {
            return new PluginContentProviderOperation[size];
        }
    };
    ...
    public static class Builder {
        ...
        public PluginContentProviderOperation build() {
            ...
            return new PluginContentProviderOperation(this);
        }
